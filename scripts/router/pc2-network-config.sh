#!/bin/bash
# PC2 Network Configuration Script
# Configures PC2 with IP: 192.168.2.2/24, Gateway: 192.168.2.1

set -e

echo "╔════════════════════════════════════════════════════════════╗"
echo "║  Configuring PC2 Network                                   ║"
echo "╠════════════════════════════════════════════════════════════╣"
echo "║  IP Address: 192.168.2.2/24                                ║"
...
echo "╔════════════════════════════════════════════════════════════╗"
echo "║  PC2 Configuration Complete!                               ║"
echo "╠════════════════════════════════════════════════════════════╣"
...
echo "  ping 192.168.2.1    # Gateway (router)"
echo "  ping 192.168.1.2    # PC1 (via router)"
echo ""
