...
export interface CapsuleProfile { id: string; version: string; name: string; image: { name: string; version: string; digest: string }; interfaces: CapsuleInterface[]; resources?: WorkloadProfileVersion['resources']; consoles?: WorkloadProfileVersion['consoles']; interfaceModels?: string[]; maxInterfaces?: number }
